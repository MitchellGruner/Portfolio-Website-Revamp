...
const About = () => {
    ...
    return (
        <div id="about" className="h-auto mt-2 mb-12 xs:mb-16 sm:mb-20 md:mb-24 lg:mb-28 xl:mb-32 2xl:mb-36">
            <div className="text-center sm:mx-20 md:mx-42 xl:mx-80 2xl:mx-96">
                <h2 className="text-3xl xs:text-4xl md:text-5xl 2xl:text-6xl font-bold text-white">Mitchell Gruner</h2>
                <h1><span className="text-xl mt-2 xs:text-2xl md:text-3xl 2xl:text-4xl font-bold text-white block"><TextTransition springConfig={presets.gentle}>{TEXTS[index % TEXTS.length]}</TextTransition></span></h1>
