    ...
    return (
        <div id="projects" className="h-auto mt-2 mb-12 xs:mb-16 sm:mb-20 md:mb-24 lg:mb-28 xl:mb-32 2xl:mb-36">
            <div className="text-center mt-10 mb-4 sm:mx-32 md:mx-42 lg:mx-56 xl:mx-80">
                ...
                <p className="text-md p-4 mb-6 xs:mb-10 2xl:mt-6 2xl:mb-14 xs:text-lg md:text-xl 2xl:text-2xl text-white">After nearly two years of professional work experience as a front end developer at Electronic Express, I have implemented several key features to the website. This includes the hamburger menu, an overhaul of the product details page card (shown below), and several brand pages for various companies; these were built using HTML and CSS, CSS Animations, JavaScript, jQuery, and Bootstrap as a CSS framework.</p>
            </div>
