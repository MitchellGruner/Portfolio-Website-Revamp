...
const Projects = (props) => {
    return (
        <div id="projects" className="h-auto mb-12 xs:mb-16 sm:mb-20 md:mb-24 lg:mb-28 xl:mb-32 2xl:mb-36">
            <div className="text-center sm:mx-20 md:mx-42 xl:mx-64">
            <h2 className="text-3xl xs:text-4xl md:text-5xl 2xl:text-6xl font-bold text-white"><p>Here are some highlights...</p></h2>
